...
Usage:
    python run.py                     # auto-detect Kinect, fall back to mock
...
def main() -> None:
    ...
    p.add_argument("--sensor", choices=["v1", "v2", "mock"], default=None,
    ...
    run(host=args.host, port=args.port, force_sensor=force, allow_mock=allow_mock)
